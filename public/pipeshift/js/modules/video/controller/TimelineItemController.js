define(['angularAMD', 'app'], function(angularAMD, app) {
    app.register.controller('TimelineItemModalController', ['$scope', '$modalInstance', 'video', 'template',
        function($scope, $modalInstance, video, template) {
            ...
            $scope.submit = function() {
                if ($scope.video.scheduledTime !== undefined) {
