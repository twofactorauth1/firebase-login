angular.module('app.modules.video').controller('VideoViewModalController', ['$scope', '$modalInstance', '$sce', 'youtube', 'video', function ($scope, $modalInstance, $sce, youtube, video) {
    var idSplit;
    var videoId;
