define(['app', 'websiteService', 'jqueryUI', 'angularUI', 'angularSortable', 'userService', 'ngAnimate', 'toaster', 'confirmClickDirective', 'colorpicker', 'angularBootstrapSwitch', 'ngProgress','mediaDirective'], function(app) {
