...
require.config({
    ...
    paths: {
        ...
        'angularIsotope': 'libs/angular-isotope/dist/angular-isotope.min',
        'angularUI': 'libs/angular-ui/build/angular-ui.min',
        'angular-calendar-ui': 'libs/angular-ui-calendar/src/calendar',
        ...
        'highcharts-standalone': 'libs/highcharts-release/adapters/standalone-framework',
        'highcharts': 'libs/highcharts-release/highcharts',
        'highcharts-ng': 'libs/highcharts-ng/dist/highcharts-ng.min',
        'highcharts-funnel': 'libs/highcharts-release/modules/funnel',
        'highmaps-us': 'libs_misc/highmaps/us-all',
        'highmaps-data': 'libs/highmaps-release/modules/map',
    ...
    shim: {
        ...
        'angularIsotope': {deps: ['isotope']},
        'angular-calendar-ui': {deps: ['jquery', 'fullcalendar']},
        'isotope': {deps: ['jquery']},
