...
;(function(window, document, undefined) {
  ...
  var sweetAlertInitialize = function() {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="sa-icon sa-error"><span class="sa-x-mark"><span class="sa-line sa-left"></span><span class="sa-line sa-right"></span></span></div><div class="sa-icon sa-warning"> <span class="sa-body"></span> <span class="sa-dot"></span> </div> <div class="sa-icon sa-info"></div> <div class="sa-icon sa-success"> <span class="sa-line sa-tip"></span> <span class="sa-line sa-long"></span> <div class="sa-placeholder"></div> <div class="sa-fix"></div> </div> <div class="sa-icon sa-custom"></div> <h2>Title</h2><p>Text</p><button class="cancel" tabIndex="2">Cancel</button><button class="confirm" tabIndex="1">OK</button><button class="noaction" tabIndex="3">No Action</button></div>',
  ...
  sweetAlert = swal = function() {
    ...
    var onButtonEvent = function(event) {
      ...
      var target = e.target || e.srcElement,
          ...
          targetedNoAction    = (target.className.indexOf("noaction") !== -1),
      ...
      switch (e.type) {
        ...
        case ("click"):
          ...
          }else if (targetedNoAction && doneFunctionExists && modalIsVisible) { // Clicked "confirm"

            params.doneFunction(undefined);
  ...
  function setParameters(params) {
    ...
    var $title = modal.querySelector('h2'),
        ...
        $noActionBtn = modal.querySelector('button.noaction'),
    ...
    modal.setAttribute('data-has-noaction-button', params.showNoActionButton);
    if (params.showNoActionButton) {
      $noActionBtn.style.display = 'inline-block';
    } else {
      hide($noActionBtn);
    }
    ...
    // Edit text on cancel and confirm and no action buttons
    ...
    if (params.noActionButtonText) {
      $noActionBtn.innerHTML = escapeHtml(params.noActionButtonText);
    }
