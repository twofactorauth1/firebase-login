...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'panel,floatpanel,dialogadvtab,contextmenu,colordialog,colorbutton,pastetext,doksoft_button,doksoft_button_email,mediamanager,sharedspace,image2,tooltip,lineheight,doksoft_font_awesome,table,tabletools,quicktable,tableresize,scroll';
