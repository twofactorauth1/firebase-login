...
CKEDITOR.dialog.add( 'anchor', function( editor ) {
	...
	function createBlankAnchor( editor, attributes ) {
		return  editor.document.createElement( 'a', {
		...
		onOk: function() {
			...
			if ( this._.selectedElement ) {
				if ( this._.selectedElement.data( 'cke-realelement' ) ) {
					var newFake = createBlankAnchor( editor, attributes );
				...
				// Empty anchor
				if ( range.collapsed ) {
					var anchor = createBlankAnchor( editor, attributes );
