...
$.FroalaEditor.build = _.memoize(function(type) {
    ...
    $.FroalaEditor.config = {
        ...
        tableEditButtons: ['tableHeader', 'tableRemove', 'tableRows', 'tableColumns', 'tableStyle', 'tableCells', 'tableCellColors', 'tableCellVerticalAlign', 'tableCellHorizontalAlign', 'tableCellStyle', 'tableCellPadding'],
        tableCellStyles: {
