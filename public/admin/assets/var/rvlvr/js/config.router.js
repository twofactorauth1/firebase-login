...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    .state('app.website.ssbSiteBuilder.editor', {
        ...
        title: 'Dashboard',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('DOHYCtrl', 'dashboardService', 'DashboardInboxComponent', 'DashboardWorkstreamTileComponentController', 'DashboardAnalyticTileComponentController', 'DashboardInboxComponentController', 'jsVideoUrlParser', 'highcharts', 'highmaps', 'highmaps-lib')
