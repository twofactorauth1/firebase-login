...
function ($rootScope, $state, $stateParams, $injector, Analytics) {
    ...
    $rootScope.app = {
        ...
        layout: {
            ...
            logo: 'assets/var/demo/images/securematics-logo.png', // relative path of the project logo
            logo2: 'assets/var/demo/images/securematics-logo.png', // relative path of the project logo
