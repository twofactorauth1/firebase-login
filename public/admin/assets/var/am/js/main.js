...
function ($rootScope, $state, $stateParams, $injector, $window, ENV) {
    ...
    $rootScope.app = {
        name: 'AM RVLVR Portal', // name of your project
        ...
        layout: {
            ...
            logo: 'assets/var/am/images/am_logo.png', // relative path of the project logo
            logo2: 'assets/var/am/images/am_logo.png', // relative path of the project logo
