...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        url: "",
        templateUrl: "/admin/assets/var/techevent/views/app.html",
    ...
    .state('app.website.ssbSiteBuilder.editor', {
        ...
        }, loadSequence('froala-wysiwyg-editor', 'froala-wysiwyg-editor-plugins', 'custom-froala-wysiwyg-editor', 'userService', 'htmlToPlaintext', 'spectrum', 'angular-slider', 'assetsService', 'toasterService', 'geocodeService', 'productService', 'paymentService', 'accountService', 'toTrusted', 'generateURLforLinks', 'truncate', 'ngSticky', 'slick', 'offset', 'jsVideoUrlParser', 'selectedTags', 'addComponentModalCtrl', 'componentSettingsModalCtrl', 'ssbComponentSettingsModalCtrl', 'googlePlaces', 'ngMap', 'angularCircularNavigation', 'campaignService', 'angular-resizable', 'wu.masonry', 'cleanType', 'filterPages', 'filterSsbSections', 'deep-diff', 'sortListPages', 'generateURLforProduct', 'ssbPostSettingsModalCtrl', 'ssbPostFilter', 'wait-for-images'))
        ...
        url: '/dashboard',
        templateUrl: "/admin/assets/var/techevent/js/dashboard/dohy.html",
        title: 'Dashboard',
        icon: 'ti-layout-media-left-alt',
