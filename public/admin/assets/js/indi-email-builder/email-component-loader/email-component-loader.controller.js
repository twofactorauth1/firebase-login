        ...
        function componentStyleFn(component) {
            ...
            if (component && component.spacing) {
                ...
                if (component.spacing.ml) {
                    styleString += component.spacing.ml == 'auto' ? 'margin-left: ' + component.spacing.ml + ';' : 'left: ' + component.spacing.ml + vm.isPxorPercent(component.spacing.ml);
                }

                if (component.spacing.mr) {
                    styleString += (component.spacing.mr == 'auto') ? 'margin-left: ' + component.spacing.mr + ';' : 'right: ' + component.spacing.mr + vm.isPxorPercent(component.spacing.mr);
                }
