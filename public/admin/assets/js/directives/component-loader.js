...
/*jslint unparam:true*/
app.directive('componentLoader', ['$timeout', '$modal', 'toaster', function ($timeout, $modal, toaster) {
  return {
...
app.directive('addNewComponent', ['$modal', '$http', '$timeout', '$q', '$compile', '$filter', 'WebsiteService', 'CustomerService', 'toaster', function ($modal, $http, $timeout, $q, $compile, $filter, WebsiteService, CustomerService, toaster) {
  return {
    require: [],
    restrict: 'C',
    transclude: false,
    replace: false,
    scope: false,
    controller: function ($scope, $timeout, WebsiteService, CustomerService) {
