  ...
  return {
    ...
    link: function (scope, elem, attrs) {
      ...
      UserService.getUserPreferences(function (preferences) {
        ...
        if (addedTask) {
            console.log('task added', scope.userPreferences.tasks);
      ...
      scope.onboardingStepMap = {
        'sign_up': [{
          type: "title",
          heading: 'Task: Sign Up For Indigenous',
          text: "Congratulations on taking the most difficult step by taking control of your online presence with Indigenous."
        }],
        'create_contact': [{
          type: "title",
