'use strict';
/*global app, Papa*/
app.controller('ImportCustomerModalCtrl', ['$scope', '$location', '$timeout', '$modalInstance', 'FileUploader', 'editableOptions', 'CustomerService', 'userConstant', 'SocialConfigService', function($scope, $location, $timeout, $modalInstance, FileUploader, editableOptions, CustomerService, userConstant, SocialConfigService) {
