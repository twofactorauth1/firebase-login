...
module.exports = {
    ...
    createTestUser: function (testClass, fn) {
        ...
        userManager.createAccountAndUser("__test_user_" + $$.u.idutils.generateUniqueAlphaNumeric(), "password", "testuser@indigenous.io", null, 'oldId', 'oldId', null, {first:'first',middle:'middle',last:'last'}, 0, function (err, accountAndUser) {
            if (err) {
