(function addressParse() {
    ...
    var _allSecondaryUnits;
    var allSecondaryUnits = function() {
        if (_allSecondaryUnits != null) {
            return _allSecondaryUnits;
        }

        _allSecondaryUnits = _.extend(rangedSecondaryUnits, rangelessSecondaryUnits, {});
    };


    var _regExp;
    var initializeRegEx = function() {
        if (_regExp) {
            return _regExp;
        }
