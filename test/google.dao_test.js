...
module.exports.group = {
    setUp: function(cb) {
        ...
        testHelpers.createTestUser(function(err, value) {
            ...
            var config = testConfig.google;
            self.user.createOrUpdateSocialCredentials($$.constants.social.types.GOOGLE,
                null,
                config.accessToken,
                null,
                null,
    ...
    testShareLink: function(test) {
        ...
        googleDao.shareLink(this.user, 'http://www.indigenous.io', 'https://s3.amazonaws.com/indigenous-account-websites/acct_6/logo.png', 'Indig-name', 'Indig-caption', 'Indig-description', function(err, value){
            if(err) {
