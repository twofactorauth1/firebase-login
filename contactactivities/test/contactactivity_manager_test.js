...
exports.contactactivity_manager_test = {
    ...
    testFindActivitiesByActivityType: function (test) {
        ...
        manager.findActivities(null, null, activityTypeAry, null, null, null, null, null, null, null, true, function (err, list) {
            if (err) {
    ...
    testFindActivitiesByText: function (test) {
        var text = 'ge';
        test.expect(2);
        manager.findActivities(null, null, null, text, null, null, null, null, null, null, true, function (err, list) {
            if (err) {
    ...
    testFindActivitiesByDateRange: function (test) {
        ...
        manager.findActivities(null, null, null, null, null, date, date, null, null, null, true, function (err, list) {
            if (err) {
