...
exports.reading_dao_test = {
    ...
    createReadingNoDevice: function(test) {
        readingDao.createReading("bad device id", "a contact id", null, [], null, null, function(err, reading) {
            test.ok(err);
    ...
    createReading: function(test) {
        ...
        readingDao.createReading(device1key, "a contact id", null, [readingValue1], "EXTID1", null, function(err, reading) {
            if (err) {
